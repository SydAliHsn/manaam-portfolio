    ...
    >
        ...
        <div className="m-auto" data-aos="fade-left"
            ...
            <p className="text-zinc-500 font-rubik font-thin w-full mt-6">
                Hello! I am an Embedded Software Developer and a Professional PCB designer with more than a year of experience in my field. During my embedded systems career, I have designed several systems based on IoT, gateway systems, BLE mesh network indeginous robots. I have also worked on designing Printed Circuit Boards(PCB) which mostly include battery charging circuits, battery Management systems, development boards and many others!
            </p>
            <p className="text-zinc-500 font-rubik font-thin w-full mt-6">
